 ...
 */
export function createI18n(locale: Locale = DEFAULT_LOCALE, ...catalogs: Catalog[]): I18n {
 ...
 */
export function loadAndActivate(i18n: I18n, locale: Locale, ...catalogs: Catalog[]): void {
