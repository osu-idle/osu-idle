import { apiUrl, rpc, unwrap } from './client';
...
export const moderateAddon = (id: number, body: { status: AddonStatus; feedback?: string | null }) =>
	unwrap(rpc.v1.addons.admin[':id'].$patch({ param: { id: String(id) }, json: body }));
