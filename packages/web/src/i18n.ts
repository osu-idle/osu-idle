 ...
 * the web app's own strings plus the catalog owned by `@osu-idle/shared` (skill
 * names etc.). Both are dynamic imports, so the browser downloads only the
 * language actually in use - not every supported catalog.
 */
