...
export const getCharacterMostPlayed = (id: number | string, page: number | string) =>
	unwrap(rpc.v1.characters[':id'].mostplayed[':page'].$get({ param: { id: String(id), page: String(page) } }));
...
export const getCharacterBestPP = (id: number | string, page: number | string) =>
	unwrap(rpc.v1.characters[':id'].bestpp[':page'].$get({ param: { id: String(id), page: String(page) } }));
...
export const getCharacterFirstPlaces = (id: number | string, page: number | string) =>
	unwrap(rpc.v1.characters[':id'].firstplaces[':page'].$get({ param: { id: String(id), page: String(page) } }));
	
export const getCharacterRecent = (id: number | string, page: number | string) =>
	unwrap(rpc.v1.characters[':id'].recent[':page'].$get({ param: { id: String(id), page: String(page) } }));